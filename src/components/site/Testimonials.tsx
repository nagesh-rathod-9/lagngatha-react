...
// Real client reviews. Sanket Sumb's Instagram handle wasn't provided —
// fill in `instagramHandle` / `instagramUrl` below once you have it and
// the card will automatically switch from "Verified Client" to a linked
// @handle, same as the others.
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    review:
      'लग्नागाथा स्टुडिओने आमचं आउटडोअर शूट अगदी ट्रॅडिशनल आणि रॉयल शेतकरी स्टाईलमध्ये अप्रतिम कॅप्चर केलं. प्रत्येक फोटोत आमच्या मातीतल्या मुळांचा अभिमान दिसतो. टीमचं काम आणि क्रिएटिव्हिटी खरंच कौतुकास्पद आहे!',
  },
  {
    name: 'Adesh Bhawar',
    ...
    review:
      'आमचं लग्न आणि आता अलीकडचं आउटडोअर शूट दोन्ही लग्नागाथा स्टुडिओनेच केलं. दोन्ही वेळा त्यांनी क्षण अगदी नैसर्गिक आणि सुंदर पद्धतीने टिपले. फोटो बघून पुन्हा तेच दिवस जगल्यासारखं वाटतं!',
  },
  {
    name: 'Sanket Sumb',
    rating: 4.9,
    ...
    review:
      'प्री-वेडिंग शूटपासून ते लग्नाच्या दिवसापर्यंत, लग्नागाथा टीमने प्रत्येक क्षण मनापासून कॅप्चर केला. त्यांची कँडिड स्टाईल आणि प्रोफेशनल अ‍ॅप्रोच खूप आवडली. अल्बम बघून डोळे भरून येतात!',
  },
  {
    ...
    review:
      'आमच्या लग्नाचं शूट लग्नागाथा स्टुडिओने केलं आणि प्रत्येक क्षण त्यांनी खूप सुंदर पद्धतीने टिपला. टीमचा नम्रपणा आणि व्यावसायिकता खरंच वाखाणण्याजोगी आहे. मनापासून धन्यवाद!',
  },
]
